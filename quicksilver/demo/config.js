...
export default {
  ...
  fields: {
    ...
    userName: {
      label: "用户名",
      type: "text",
      operators: ["match", "not_match", "equal", "not_equal"],
      defaultOperator: "match",
      mainWidgetProps: {
        formatValue: (val, fieldDef, wgtDef, isForDisplay) =>
          "__" + JSON.stringify(val),
        valueLabel: "valueLabelUsername",
        valuePlaceholder: "valuePlaceholderUsername",
        validateValue: (val, fieldDef) => {
          return val != "validateValueUsername";
        }
      }
    },
    phoneNumber: {
